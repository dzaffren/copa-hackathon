...
- [Frontend app is `frontend/`, not `web/`](convention-frontend-app-is-frontend-dir.md) — Workstream Brain UI lives in frontend/ (Vite + React 18); web/ is the superseded Next.js app; a build step is intentional
