...
import { resetReviewState } from "./msw/handlers";
...
afterEach(() => {
  ...
  // The review handlers hold review_state in a module-level map so PATCH
  // round-trips persist within a test; clear it so tests stay independent.
  resetReviewState();
});
