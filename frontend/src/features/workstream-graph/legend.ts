...
// Colour + label maps for the graph canvas and detail panels (see index.css +
// CLAUDE.md for the app's single light theme): saturated node fills that read
// on the light canvas backdrop, with translucent Tailwind badge classes
// (darker text weights for contrast on white) for the panels. One source of
// truth for every node/edge colour in the app.
...
export const NODE_LEGEND: Record<NodeType, NodeStyle> = {
  task: {
    label: "task",
    fill: "#2563eb", // primary blue — the hero node
    stroke: "#60a5fa",
    text: "#eff6ff",
  ...
  "international-standard": {
    ...
    stroke: "#fcd34d",
    text: "#3a2606",
    badge: "bg-amber-400/15 text-amber-700 border-amber-300/30",
  },
  "peer-regulator": {
  ...
  "supervisory-letter": {
    ...
    stroke: "#c4b5fd",
    text: "#1e1b3a",
    badge: "bg-violet-500/15 text-violet-700 border-violet-400/30",
  },
  others: {
    label: "others",
    ...
    stroke: "#cbd5e1",
    text: "#0b1220",
    badge: "bg-slate-400/15 text-slate-700 border-slate-400/30",
  },
};
